...
var G__12350 = o;
(G__12350[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__12358 = jsprops;
(G__12358["defaultValue"] = value);

(G__12358["onChange"] = ((function (G__12358,v,value,on_change){
return (function (p1__12356_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__12356_SHARP_);
});})(G__12358,v,value,on_change))
);
...
var vec__12363 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12363,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12363,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12363,(2),null);
...
var jsprops = {"argv": v};
var temp__4429__auto___12366 = reagent.impl.template.key_from_vec(v);
if((temp__4429__auto___12366 == null)){
} else {
var key_12367 = temp__4429__auto___12366;
(jsprops["key"] = key_12367);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__12369 = (new reagent.impl.template.NativeWrapper());
(G__12369["name"] = c);
...
var G__12371 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__12371) : reagent.impl.template.as_element.call(null,G__12371));
} else {
...
var len__7513__auto___12377 = arguments.length;
var i__7514__auto___12378 = (0);
while(true){
if((i__7514__auto___12378 < len__7513__auto___12377)){
args__7520__auto__.push((arguments[i__7514__auto___12378]));

var G__12379 = (i__7514__auto___12378 + (1));
i__7514__auto___12378 = G__12379;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq12375){
var G__12376 = cljs.core.first(seq12375);
var seq12375__$1 = cljs.core.next(seq12375);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__12376,seq12375__$1);
});
...
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str(reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(v,cljs.core.array_seq(["Invalid Hiccup tag"], 0))),cljs.core.str("\n"),cljs.core.str(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([cljs.core.list(new cljs.core.Symbol(null,"=","=",-1501502141,null),">",new cljs.core.Symbol(null,"n","n",-2092305744,null))], 0)))].join('')));
}

if((typeof comp === 'string') || (cljs.core.fn_QMARK_(comp))){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str(reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(v,cljs.core.array_seq(["Expected React component in"], 0))),cljs.core.str("\n"),cljs.core.str(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([cljs.core.list(new cljs.core.Symbol(null,"or","or",1876275696,null),cljs.core.list(new cljs.core.Symbol(null,"string?","string?",-1129175764,null),new cljs.core.Symbol(null,"comp","comp",-1462482139,null)),cljs.core.list(new cljs.core.Symbol(null,"fn?","fn?",1820990818,null),new cljs.core.Symbol(null,"comp","comp",-1462482139,null)))], 0)))].join('')));
}
...
break;
default:
var G__12383 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__12383;
continue;
...
var n__7358__auto___12384 = a.length;
var i_12385 = (0);
while(true){
if((i_12385 < n__7358__auto___12384)){
(a[i_12385] = reagent.impl.template.as_element((a[i_12385])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__7358__auto___12387 = a.length;
var i_12388 = (0);
while(true){
if((i_12388 < n__7358__auto___12387)){
var val_12389 = (a[i_12388]);
if((cljs.core.vector_QMARK_(val_12389)) && ((reagent.impl.template.key_from_vec(val_12389) == null))){
(o["no-key"] = true);
} else {
}

(a[i_12388] = reagent.impl.template.as_element(val_12389));
...
var ctx = {};
var vec__12392 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12392,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12392,(1),null);
...
var G__12394 = (cljs.core.count(argv) - first_child);
switch (G__12394) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__12394){
