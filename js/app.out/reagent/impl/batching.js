...
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([cljs.core.list(new cljs.core.Symbol(null,"some?","some?",234752293,null),new cljs.core.Symbol(null,"f","f",43394975,null))], 0)))].join('')));
}
...
var G__12074 = ((function (this$){
return (function (){
return this$.run_queues();
});})(this$))
;
return (reagent.impl.batching.next_tick.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.batching.next_tick.cljs$core$IFn$_invoke$arity$1(G__12074) : reagent.impl.batching.next_tick.call(null,G__12074));
}
});
...
var temp__4429__auto___12076 = (this$["componentQueue"]);
if((temp__4429__auto___12076 == null)){
} else {
var cs_12077 = temp__4429__auto___12076;
(this$["componentQueue"] = null);

reagent.impl.batching.run_queue(cs_12077);
}
