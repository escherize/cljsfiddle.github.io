...
if((i < len)){
var k = (ks[i]);
var G__12274 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__12275 = (i + (1));
m = G__12274;
i = G__12275;
continue;
...
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__12279 = c;
var G__12279__$1 = (((G__12279 == null))?null:G__12279.prototype);
var G__12279__$2 = (((G__12279__$1 == null))?null:(G__12279__$1["reagentRender"]));
return G__12279__$2;
})()));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__12283 = c;
var G__12283__$1 = (((G__12283 == null))?null:G__12283.prototype);
var G__12283__$2 = (((G__12283__$1 == null))?null:(G__12283__$1["render"]));
return G__12283__$2;
})()));
});
...
var _STAR_current_component_STAR_12292 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_12292;
}});
...
var G__12300 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__12300) {
...
return ((function (G__12300){
return (function reagent$impl$component$custom_wrapper_$_getInitialState(){
var c = this;
var G__12303 = reagent.impl.component.state_atom(c);
var G__12304 = f.call(c,c);
return (cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(G__12303,G__12304) : cljs.core.reset_BANG_.call(null,G__12303,G__12304));
});
;})(G__12300))
...
var c = this;
var G__12306_12308 = (c["cljsRatom"]);
var G__12306_12309__$1 = (((G__12306_12308 == null))?null:reagent.ratom.dispose_BANG_(G__12306_12308));
...
var renders_12312 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_12313 = cljs.core.first(cljs.core.vals(renders_12312));
if((cljs.core.count(renders_12312) > (0))){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str("Missing reagent-render"),cljs.core.str("\n"),cljs.core.str(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([cljs.core.list(new cljs.core.Symbol(null,"pos?","pos?",-244377722,null),cljs.core.list(new cljs.core.Symbol(null,"count","count",-514511684,null),new cljs.core.Symbol(null,"renders","renders",-925348398,null)))], 0)))].join('')));
}

if(((1) === cljs.core.count(renders_12312))){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str("Too many render functions supplied"),cljs.core.str("\n"),cljs.core.str(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([cljs.core.list(new cljs.core.Symbol(null,"==","==",-234118149,null),(1),cljs.core.list(new cljs.core.Symbol(null,"count","count",-514511684,null),new cljs.core.Symbol(null,"renders","renders",-925348398,null)))], 0)))].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_12313)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("Render must be a function, not "),cljs.core.str(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([render_fun_12313], 0)))].join('')),cljs.core.str("\n"),cljs.core.str(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([cljs.core.list(new cljs.core.Symbol(null,"ifn?","ifn?",-2106461064,null),new cljs.core.Symbol(null,"render-fun","render-fun",-1209513086,null))], 0)))].join('')));
}
...
var name__$1 = (function (){var G__12311 = name;
switch (G__12311) {
case "":
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(fmap__$1,new cljs.core.Keyword(null,"displayName","displayName",-809144601),name__$1,cljs.core.array_seq([new cljs.core.Keyword(null,"autobind","autobind",-570650245),false,new cljs.core.Keyword(null,"cljsLegacyRender","cljsLegacyRender",-1527295613),legacy_render,new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),render_fun__$1,new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"render","render",-1408033454).cljs$core$IFn$_invoke$arity$1(reagent.impl.component.static_fns)], 0));
});
reagent.impl.component.map_to_js = (function reagent$impl$component$map_to_js(m){
return cljs.core.reduce_kv((function (o,k,v){
var G__12316 = o;
(G__12316[cljs.core.name(k)] = v);
...
var elem = (function (){var G__12322 = (function (){var or__6455__auto__ = (function (){var G__12324 = c;
var G__12324__$1 = (((G__12324 == null))?null:(G__12324["_reactInternalInstance"]));
return G__12324__$1;
})();
if(cljs.core.truth_(or__6455__auto__)){
return or__6455__auto__;
...
var G__12322__$1 = (((G__12322 == null))?null:(G__12322["_currentElement"]));
return G__12322__$1;
})();
var name = (function (){var G__12325 = elem;
var G__12325__$1 = (((G__12325 == null))?null:(G__12325["type"]));
var G__12325__$2 = (((G__12325__$1 == null))?null:(G__12325__$1["displayName"]));
return G__12325__$2;
})();
var path = (function (){var G__12326 = elem;
var G__12326__$1 = (((G__12326 == null))?null:(G__12326["_owner"]));
var G__12326__$2 = (((G__12326__$1 == null))?null:reagent$impl$component$component_path(G__12326__$1));
var G__12326__$3 = (((G__12326__$2 == null))?null:[cljs.core.str(G__12326__$2),cljs.core.str(" > ")].join(''));
return G__12326__$3;
})();
...
var G__12328 = c;
var G__12328__$1 = (((G__12328 == null))?null:G__12328.constructor);
var G__12328__$2 = (((G__12328__$1 == null))?null:reagent.impl.util.fun_name(G__12328__$1));
return G__12328__$2;
}
})();
