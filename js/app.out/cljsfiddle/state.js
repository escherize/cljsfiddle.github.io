...
cljsfiddle.state.state = (function (){var G__14000 = cljs.core.PersistentArrayMap.EMPTY;
...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(cljsfiddle.state.state,(function (p1__14001_SHARP_){
return cljsfiddle.state.update_state_text(p1__14001_SHARP_,new_text);
}));
});
