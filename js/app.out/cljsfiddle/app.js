...
return cljs.js.eval_str.cljs$core$IFn$_invoke$arity$5(cljs.js.empty_state.cljs$core$IFn$_invoke$arity$0(),[cljs.core.str("(ns cljs.user)\n                  (def atom reagent.core/atom)"),cljs.core.str(cljs_string)].join(''),new cljs.core.Symbol(null,"dummy-symbol","dummy-symbol",-412954789,null),new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"ns","ns",441598760),new cljs.core.Symbol(null,"cljs.user","cljs.user",877795071,null),new cljs.core.Keyword(null,"eval","eval",-1103567905),cljs.js.js_eval,new cljs.core.Keyword(null,"static-fns","static-fns",-501950748),true,new cljs.core.Keyword(null,"def-emits-var","def-emits-var",-1551927320),true,new cljs.core.Keyword(null,"load","load",-1318641184),(function() { 
var G__14281__delegate = function (_){
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"lang","lang",-1819677104),new cljs.core.Keyword(null,"clj","clj",-660495428),new cljs.core.Keyword(null,"source","source",-433931539),"."], null);
};
...
while (G__14282__i < G__14282__a.length) {G__14282__a[G__14282__i] = arguments[G__14282__i + 0]; ++G__14282__i;}
  _ = new cljs.core.IndexedSeq(G__14282__a,0);
} 
return G__14281__delegate.call(this,_);};
G__14281.cljs$lang$maxFixedArity = 0;
G__14281.cljs$lang$applyTo = (function (arglist__14283){
var _ = cljs.core.seq(arglist__14283);
return G__14281__delegate(_);
});
G__14281.cljs$core$IFn$_invoke$arity$variadic = G__14281__delegate;
return G__14281;
})()
,new cljs.core.Keyword(null,"context","context",-830191113),new cljs.core.Keyword(null,"statement","statement",-32780863)], null),(function (p__14277){
var map__14278 = p__14277;
var map__14278__$1 = ((((!((map__14278 == null)))?((((map__14278.cljs$lang$protocol_mask$partition0$ & (64))) || (map__14278.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__14278):map__14278);
var x = map__14278__$1;
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14278__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14278__$1,new cljs.core.Keyword(null,"value","value",305978217));
if(cljs.core.truth_(error)){
cljsfiddle.app._STAR_er = x;

var G__14280 = [cljs.core.str(error)].join('');
return console.log(G__14280);
} else {
return value;
}
}));
...
var G__14287 = document.getElementById("baby-dom-target");
return (reagent.core.render_component.cljs$core$IFn$_invoke$arity$2 ? reagent.core.render_component.cljs$core$IFn$_invoke$arity$2(G__14286,G__14287) : reagent.core.render_component.call(null,G__14286,G__14287));
});
cljsfiddle.app.run = (function cljsfiddle$app$run(){
cljsfiddle.app.clear();

var G__14290 = cljsfiddle.app.my_eval(cljsfiddle.state.read_state());
var G__14291 = document.getElementById("baby-dom-target");
return (reagent.core.render_component.cljs$core$IFn$_invoke$arity$2 ? reagent.core.render_component.cljs$core$IFn$_invoke$arity$2(G__14290,G__14291) : reagent.core.render_component.call(null,G__14290,G__14291));
});
...
var gist_id = (function (){var or__6455__auto__ = cljsfiddle.gist.get_anchor("gist");
...
var G__14294_14296 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljsfiddle.app.home], null);
var G__14295_14297 = document.getElementById("appContainer");
(reagent.core.render_component.cljs$core$IFn$_invoke$arity$2 ? reagent.core.render_component.cljs$core$IFn$_invoke$arity$2(G__14294_14296,G__14295_14297) : reagent.core.render_component.call(null,G__14294_14296,G__14295_14297));
