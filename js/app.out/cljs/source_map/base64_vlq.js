...
var digit_9007 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_9008__$1 = (vlq >>> cljs.source_map.base64_vlq.vlq_base_shift);
while(true){
if((vlq_9008__$1 > (0))){
var digit_9009__$1 = (digit_9007 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode(digit_9009__$1));

var G__9010 = (vlq_9008__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__9011 = (vlq_9008__$1 >>> cljs.source_map.base64_vlq.vlq_base_shift);
digit_9007 = G__9010;
vlq_9008__$1 = G__9011;
continue;
} else {
sb.append(cljs.source_map.base64.encode(digit_9007));
}
break;
}
...
var G__9012 = i__$1;
var G__9013 = result__$1;
var G__9014 = shift__$1;
i = G__9012;
result = G__9013;
shift = G__9014;
continue;
